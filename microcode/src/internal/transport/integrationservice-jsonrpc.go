...
func (http *httpIntegrationService) _serveMethod(ctx *fiber.Ctx, methodName string, methodHandler methodJsonRPC) (err error) {
...
func (http *httpIntegrationService) doBatch(ctx *fiber.Ctx, requests []baseJsonRPC) (responses jsonrpcResponses) {
...
func (http *httpIntegrationService) serveBatch(ctx *fiber.Ctx) (err error) {
...
func (http *httpIntegrationService) doSingleBatch(ctx *fiber.Ctx, request baseJsonRPC) (response *baseJsonRPC) {
