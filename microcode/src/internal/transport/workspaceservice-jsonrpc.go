...
func (http *httpWorkspaceService) _serveMethod(ctx *fiber.Ctx, methodName string, methodHandler methodJsonRPC) (err error) {
...
func (http *httpWorkspaceService) doBatch(ctx *fiber.Ctx, requests []baseJsonRPC) (responses jsonrpcResponses) {
...
func (http *httpWorkspaceService) serveBatch(ctx *fiber.Ctx) (err error) {
...
func (http *httpWorkspaceService) doSingleBatch(ctx *fiber.Ctx, request baseJsonRPC) (response *baseJsonRPC) {
