...
func AuthService(svc *httpAuthService) Option {
	return func(srv *Server) {
		if srv.srvHTTP != nil {
			srv.httpAuthService = svc
...
func IntegrationService(svc *httpIntegrationService) Option {
	return func(srv *Server) {
		if srv.srvHTTP != nil {
			srv.httpIntegrationService = svc
			svc.maxBatchSize = srv.maxBatchSize
			svc.maxParallelBatch = srv.maxParallelBatch
			svc.SetRoutes(srv.Fiber())
		}
...
func TaskService(svc *httpTaskService) Option {
	return func(srv *Server) {
		if srv.srvHTTP != nil {
			srv.httpTaskService = svc
			svc.maxBatchSize = srv.maxBatchSize
			svc.maxParallelBatch = srv.maxParallelBatch
			svc.SetRoutes(srv.Fiber())
		}
...
func WorkspaceService(svc *httpWorkspaceService) Option {
	return func(srv *Server) {
		if srv.srvHTTP != nil {
			srv.httpWorkspaceService = svc
			svc.maxBatchSize = srv.maxBatchSize
			svc.maxParallelBatch = srv.maxParallelBatch
			svc.SetRoutes(srv.Fiber())
		}
